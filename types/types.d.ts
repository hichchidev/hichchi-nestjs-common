...
export type QuerySafeDeepPartial<T> = T extends Array<any> ? never : T extends object ? {
    [P in keyof T]?: T[P] extends Array<infer U> ? never : T[P] extends Date ? never : T[P] extends object ? QuerySafeDeepPartial<T[P]> : T[P];
} : T;
